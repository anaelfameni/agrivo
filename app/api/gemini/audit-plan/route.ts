  ...
  if (geminiLiveEnabled()) {
    try {
      const raw = await callGemini(
        ...
        // thinkingBudget 0 : la mise en mots n'a pas besoin de « réflexion » (latence ÷ 2-3,
        // fiabilité live en prod) ; 3072 garde de la marge pour le JSON complet.
        { system: CHARTE_SYSTEM, json: true, maxOutputTokens: 3072, thinkingBudget: 0 },
      );
