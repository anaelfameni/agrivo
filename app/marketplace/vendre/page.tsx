...
const TR = {
  fr: {
    ...
    feeBody: `Pas encore prêt à publier ? Notre équipe prépare votre premier dossier « Lot scellé » en service, facturé par lot (sur devis). Ensuite, AGRIVO prélève une commission de ${pct(TAUX_COMMISSION_MIN)} à ${pct(TAUX_COMMISSION_MAX)} sur la transaction, uniquement quand la vente se conclut. Le producteur ne paie jamais.`,
  ...
  en: {
    ...
    feeBody: `Not ready to list yet? Our team prepares your first Sealed Lot file as a service, billed per lot (on quote). Then AGRIVO takes a ${pct(TAUX_COMMISSION_MIN)} to ${pct(TAUX_COMMISSION_MAX)} commission on the transaction, only when the sale closes. The producer never pays.`,
