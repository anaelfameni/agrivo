...
export function ActivityTicker() {
  ...
  return (
    <div className="sticky bottom-0 z-40 border-t border-white/10 bg-forest-950 text-white">
      <div className="flex items-center gap-4 px-5 py-2.5 sm:px-8 lg:px-12">
        ...
        <div className="relative flex-1 overflow-hidden">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-y-0 left-0 w-10 bg-gradient-to-r from-forest-950 to-transparent" />
          <div aria-hidden className="pointer-events-none absolute inset-y-0 right-0 w-10 bg-gradient-to-l from-forest-950 to-transparent" />
        </div>
      </div>
    </div>
  );
