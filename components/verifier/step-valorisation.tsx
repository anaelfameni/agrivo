...
const COPY = {
  fr: {
    ...
    memoLive: "Rédigé par l'IA · en direct",
    memoCache: (h: string) => `Rédigé par l'IA à ${h}`,
    memoDemo: "Réponse vérifiée",
  ...
  en: {
    ...
    memoLive: "Written by AI · live",
    memoCache: (h: string) => `Written by AI at ${h}`,
    memoDemo: "Verified answer",
