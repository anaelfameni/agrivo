...
const COPY = {
  fr: {
    ...
    live: "Gemini Vision · en direct",
    demo: "Mode démonstration",
    disclaimer: "Observation terrain qualitative. N'établit pas le verdict de déforestation, qui reste défini par l'analyse satellite Whisp.",
  ...
  en: {
    ...
    live: "Gemini Vision · live",
    demo: "Demo mode",
    disclaimer: "Qualitative field observation. Does not establish the deforestation verdict, which remains defined by the Whisp satellite analysis.",
