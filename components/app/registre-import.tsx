...
const COPY = {
  fr: {
    ...
    planLive: "Rédigé par l'IA · en direct",
    planCache: (h: string) => `Rédigé par l'IA à ${h}`,
    planDemo: "Réponse vérifiée",
  ...
  en: {
    ...
    planLive: "Written by AI · live",
    planCache: (h: string) => `Written by AI at ${h}`,
    planDemo: "Verified answer",
