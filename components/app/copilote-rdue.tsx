...
const UI = {
  fr: {
    ...
    accroche: "Bonjour, je suis l'Assistant AGRIVO 👋 Je vous guide dans le site et je réponds à toutes vos questions sur AGRIVO (prix, parcours, verdicts, comptes) et sur le règlement européen, à partir de faits vérifiés. Pour une demande complexe : support@agrivo.ci.",
  ...
  en: {
    ...
    accroche: "Hello, I am the AGRIVO Assistant 👋 I guide you through the site and answer all your questions about AGRIVO (pricing, journey, verdicts, accounts) and the EU regulation, from verified facts. For complex requests: support@agrivo.ci.",
