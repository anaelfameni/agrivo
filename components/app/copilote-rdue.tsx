...
const UI = {
  fr: {
    ouvrir: "Ouvrir le copilote de conformité RDUE",
    fermer: "Fermer",
    titre: "Copilote RDUE",
    sous: "Vos questions sur le règlement, en clair.",
    accroche: "Posez une question sur le règlement européen contre la déforestation. Je réponds à partir de faits vérifiés et sourcés.",
    placeholder: "Ex. : la Côte d'Ivoire est-elle concernée ?",
    envoyer: "Envoyer",
    live: "IA en direct",
    base: "Base RDUE vérifiée",
    source: "Source",
  ...
  en: {
    ouvrir: "Open the EUDR compliance copilot",
    fermer: "Close",
    titre: "EUDR Copilot",
    sous: "Your questions on the regulation, made clear.",
    accroche: "Ask a question about the EU Deforestation Regulation. I answer from verified, sourced facts.",
    placeholder: "E.g.: is Côte d'Ivoire concerned?",
    envoyer: "Send",
    live: "AI live",
    base: "Verified EUDR base",
    source: "Source",
