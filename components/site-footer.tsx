...
const COLS_FR = [
  { title: "Produit", links: [{ label: "Méthodologie", href: "/methodologie" }, { label: "Tarifs", href: "/tarifs" }, { label: "Tableau de bord", href: "/app/dashboard" }] },
...
const COLS_EN = [
  { title: "Product", links: [{ label: "Method", href: "/methodologie" }, { label: "Pricing", href: "/tarifs" }, { label: "Dashboard", href: "/app/dashboard" }] },
