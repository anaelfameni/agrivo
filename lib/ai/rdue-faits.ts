...
export const FAITS_RDUE: FaitRDUE[] = [
  ...
  {
    id: "simplification",
    motsCles: ["simplification", "simplifie", "allege", "reduction", "paquet", "reference", "numero", "premier", "operateur", "aval", "downstream", "package", "simplified", "2026/1565", "1565", "13 juillet", "acte delegue", "delegated act", "implementing regulation", "reglement d'execution", "declaration simplifiee", "simplified declaration"],
    question: { fr: "Qu'a changé la simplification de 2026 ?", en: "What did the 2026 simplification change?" },
    reponse: {
      fr: "Deux vagues en 2026, sans toucher aux échéances. Le paquet de mai réduit d'environ 75 % les coûts de conformité : seul le premier opérateur qui met le produit sur le marché de l'Union dépose la déclaration complète, l'aval se contente d'en référencer le numéro. Puis le 13 juillet 2026, la Commission a adopté un acte délégué actualisant la liste des produits couverts et le règlement d'exécution (UE) 2026/1565 (en vigueur depuis le 17 juillet) : spécifications d'API du système d'information mises à jour et déclarations simplifiées pour les micro et petits opérateurs primaires. La Commission a confirmé que le règlement ne serait pas rouvert.",
      en: "Two waves in 2026, with no change to the deadlines. The May package cuts compliance costs by about 75%: only the first operator placing the product on the Union market files the full statement, downstream operators just reference its number. Then on 13 July 2026 the Commission adopted a delegated act updating the product scope and Implementing Regulation (EU) 2026/1565 (in force since 17 July): updated information-system API specifications and simplified declarations for micro and small primary operators. The Commission confirmed the regulation will not be reopened.",
    },
    source: { fr: "Commission européenne, revue de simplification (4 mai 2026) et mesures du 13 juillet 2026", en: "European Commission, simplification review (4 May 2026) and 13 July 2026 measures" },
  },
  {
    id: "ghana",
  ...
  },
  {
    ...
    reponse: {
      fr: "La DDS est la déclaration de diligence raisonnée que l'opérateur dépose dans TRACES, le système d'information de la Commission européenne, avant toute mise sur le marché de l'UE : géolocalisation des parcelles d'origine, évaluation de risque documentée, attestation de légalité. Le dépôt renvoie un numéro de référence et un numéro de vérification, exigés en douane et transmis dans la chaîne commerciale. L'opérateur est le premier metteur sur le marché de l'Union, en général l'importateur européen ; l'exportateur ivoirien lui fournit la preuve. AGRIVO prépare ce dossier en un clic pour chaque expédition : le GeoJSON au format TRACES NT (dont les spécifications d'API ont été mises à jour le 13 juillet 2026, règlement d'exécution (UE) 2026/1565), un brouillon de déclaration (denrée, code SH, masse nette, pays de production) et un rapport des éléments réunis pour l'évaluation de risque. Le dépôt reste l'acte de l'opérateur, seul responsable : l'opérateur dépose, l'exportateur prouve, AGRIVO prépare.",
      en: "The DDS is the due diligence statement the operator files in TRACES, the European Commission's information system, before any placing on the EU market: geolocation of the plots of origin, documented risk assessment, legality attestation. Filing returns a reference number and a verification number, required at customs and passed along the commercial chain. The operator is the first placer on the Union market, usually the EU importer; the Ivorian exporter supplies them with the evidence. AGRIVO prepares this file in one click for every shipment: the TRACES NT GeoJSON (whose API specifications were updated on 13 July 2026, Implementing Regulation (EU) 2026/1565), a statement draft (commodity, HS code, net mass, country of production) and a report of the elements gathered for the risk assessment. Filing remains the operator's act, who stays solely responsible: the operator files, the exporter proves, AGRIVO prepares.",
    },
    source: { fr: "Commission européenne, système d'information TRACES (mesures du 13 juillet 2026)", en: "European Commission, TRACES information system (13 July 2026 measures)" },
  },
